          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="proses_register.php">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block btn-primary btn-user">Regist</button>
                </div>
              </form>
              <hr>
              <div class="text-center">
                <span class="small">Already have an account?</span> <a class="small" href="login.php">Login!</a>
              </div>
            </div>
          </div>
        </div>
