    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#" ><i class="fas fa-dollar-sign mr-2"></i>Data Transaksi</a>
                </li>
                <li>
                    <a href="../data trans_detail/transdet.php"><i class="fas fa-info-circle mr-2"></i>Data Transaksi Detail</a>
                </li>
